...
export function Sidebar() {
    ...
    <>
      <div className="mb-6 md:mb-12">
        <Link 
          href="/" 
          prefetch={true} 
          className="p-2 bg-gradient-to-br from-pedreiro-purple to-pedreiro-blue rounded-lg block"
        ...
        {roles.map((role) => {
          ...
          return (
            ...
            >
              <div
                className={clsx(
                  "absolute left-0 w-1 h-8 rounded-r-full transition-all duration-300 bg-pedreiro-purple hidden md:block",
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex fixed left-0 top-0 h-screen w-20 flex-col items-center bg-pedreiro-card border-r border-white/10 py-8 z-50">
        <NavContent />
      </aside>

      {/* Mobile Bottom Navigation */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-pedreiro-card/95 backdrop-blur-lg border-t border-white/10 z-50 safe-area-inset-bottom">
        <div className="flex items-center justify-around px-2 py-2">
          <Link
            ...
            className={clsx(
              ...
              pathname === "/" ? "text-pedreiro-purple" : "text-gray-500"
            )}
            onClick={closeMobileMenu}
          >
          ...
          {roles.slice(0, 3).map((role) => {
            ...
            return (
              <Link
                ...
                className={clsx(
                  "flex flex-col items-center justify-center gap-1 p-2 rounded-lg transition-all min-w-[60px]",
                  isActive ? "text-white bg-pedreiro-purple/20" : "text-gray-500"
                )}
                onClick={closeMobileMenu}
              >
          ...
          <button
            ...
            className={clsx(
              "flex flex-col items-center justify-center gap-1 p-2 rounded-lg transition-all min-w-[60px]",
              isMobileMenuOpen ? "text-pedreiro-purple bg-pedreiro-purple/20" : "text-gray-500"
            )}
          >
      ...
      {isMobileMenuOpen && (
        <>
          ...
          {/* Menu Content */}
          <div className="fixed bottom-0 left-0 right-0 bg-pedreiro-card border-t border-white/10 rounded-t-3xl z-50 max-h-[80vh] overflow-y-auto safe-area-inset-bottom md:hidden animate-slide-up">
            <div className="p-6">
              ...
              <div className="space-y-2">
                  ...
                  return (
                    <Link
                      ...
                      className={clsx(
                        ...
                        isActive ? "bg-pedreiro-purple/20 text-white" : "bg-white/5 text-gray-400 hover:bg-white/10 hover:text-white"
                      )}
                      onClick={closeMobileMenu}
                    >
                ...
                <Link
                  ...
                  className={clsx(
                    "flex items-center gap-4 p-4 rounded-xl transition-all",
                    pathname === "/champs" ? "bg-pedreiro-purple/20 text-white" : "bg-white/5 text-gray-400 hover:bg-white/10 hover:text-white"
                  )}
                  onClick={closeMobileMenu}
                >
                ...
                <Link
                  ...
                  className={clsx(
                    "flex items-center gap-4 p-4 rounded-xl transition-all",
                    pathname === "/champion-pool" ? "bg-pedreiro-purple/20 text-white" : "bg-white/5 text-gray-400 hover:bg-white/10 hover:text-white"
                  )}
                  onClick={closeMobileMenu}
                >
                ...
                <Link
                  ...
                  className={clsx(
                    "flex items-center gap-4 p-4 rounded-xl transition-all",
                    pathname === "/composicoes" ? "bg-pedreiro-purple/20 text-white" : "bg-white/5 text-gray-400 hover:bg-white/10 hover:text-white"
                  )}
                  onClick={closeMobileMenu}
                >
